...
- removed "Powered by Wordpress & rdmbase" from footer, because let's face it: we all delete this anyway.
...
- removed default "rdmbase" text in footer if you don't have a menu
...
- added rdmbase body class depending on what browser
...
- added post formats to rdmbase.php core
...
- fixed error in rdmbase.php for menu fallback **thanks Mark**
...
- moved the custom script call and pngfix to the footer
	from the rdmbase file so it's easier to see what's being
	called.
